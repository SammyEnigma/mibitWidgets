...
{
    tip1->showTip("This is a demo for the mibitTip class.. The tip slides down below its partner control.",1);
}

void mainView::showTip3()
{
    tip3->showTip("This is a demo for the mibitTip class.. We also can draw it above the control, sliding up..",1);
}
